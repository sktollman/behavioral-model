...
#include <bm/simple_sume_switch/runner.h>
...
SimpleSumeSwitchRunner::SimpleSumeSwitchRunner(uint32_t cpu_port)
    : cpu_port(cpu_port),
      simple_switch(
          new SimpleSumeSwitch(/*512  max_port ,*/ true /* enable_swap */)) { }

SimpleSumeSwitchRunner::~SimpleSumeSwitchRunner() = default;

int SimpleSumeSwitchRunner::init_and_start(const bm::OptionsParser &parser) {
